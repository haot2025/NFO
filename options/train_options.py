...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--load_epoch', type=str, default='500',
                            help='which epoch to load? set to latest to use latest cached model')

        # training parameters
        parser.add_argument('--epoch_count', type=int, default=1, help='Which epoch to start the training process')
        parser.add_argument('--epoch_end', type=int, default=150000, help='Which epoch to terminate the training process')
