...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='nfo', choices=['nfo'],
                            help='chooses which model to use. [nfo]')
        ...
        parser.add_argument('--dataroot', type=str, default='./dataset/fodf/train_try/', help='path to DWI data (should have subfolders human no)')
